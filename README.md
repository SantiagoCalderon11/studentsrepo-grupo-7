...
1. **Clonar el repositorio:**
   ```bash
   git clone [https://github.com/Mariana20209/studentsrepo-momento-1.git](https://github.com/Mariana20209/studentsrepo-momento-1.git)

2. **Entrar a la carpeta:**
   cd studentsrepo-momento-1
...
|-------------------------|----------------------------|--------------------|
| Mariana Suarez          | Header                     | @Mariana20209      |
| Santiago Calderón       | Main                       | @SantiagoCalderon11|
| Viadis Correa           | Footer                     | @vcorreaga         |
